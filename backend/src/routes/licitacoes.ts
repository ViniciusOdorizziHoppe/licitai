    ...
    for (const c of contratacoes) {
      ...
      await prisma.licitacao.create({
        data: {
          ...
          dataAbertura: c.dataAberturaProposta ? new Date(c.dataAberturaProposta) : null,
          dataEncerramento: c.dataEncerramentoProposta ? new Date(c.dataEncerramentoProposta) : null,
